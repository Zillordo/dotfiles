...
[Read from: /tmp/pi-subagents-uid-1000/chain-runs/cfbc6c71/context.md]
[Write to: /tmp/pi-subagents-uid-1000/chain-runs/cfbc6c71/plan.md]

plan the implementation based on recommended interfcae
