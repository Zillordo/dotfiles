...
Constraint for this design: Minimize method/component count; aim for the smallest surface area that still handles both collapsible sections and summary rows.
