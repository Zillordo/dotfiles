...
Constraint for this design: Optimize for the most common case in this codebase: two category sections (income/costs) plus summary rows (net/final), while still leaving a path for extension.
